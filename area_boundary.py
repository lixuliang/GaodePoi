...
@author: ecidi
# input 杭州,key
# output (120.721945, 118.344933, 30.566516, 29.188757)
"""
...
'''
num = 0
#ad = getSubName(addr_name, key)  # 得到福州下属区域的城市代码
add = getlnglat(addr_name, key)  # 得到福州整个的边界数据

while num < len(ad):
    add = pd.concat([add, getlnglat(ad[num].encode("utf-8"), key)])  # 得到福州下属的全部区域的边界数据
    num += 1
